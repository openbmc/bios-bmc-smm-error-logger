...
class FileHandlerInterface
{
  public:
     ...
     */
    virtual bool createFolder(std::string_view path) const = 0;
     ...
     * @return true if successful.
     */
    virtual bool createFile(std::string_view path,
                            nlohmann::json& jsonPdr) const = 0;
};
...
{
  public:
    bool createFolder(std::string_view folderPath) const override;
    bool createFile(std::string_view folderPath,
                    nlohmann::json& jsonPdr) const override;
};
...
class ExternalStorerFileInterface : public ExternalStorerInterface
{
  ...
  private:
     ...
     */
    JsonPdrType getSchemaType(nlohmann::json& jsonSchema) const;
     ...
     * @return true if successful.
     */
    bool processLogEntry(nlohmann::json& logEntry) const;
     ...
     * @return true if successful.
     */
    bool processLogService(nlohmann::json& logService);
     ...
     * @return true if successful.
     */
    bool processOtherTypes(nlohmann::json& jsonPdr) const;
     ...
     * @return true if successful.
     */
    bool createFile(const std::string& subPath, nlohmann::json& jsonPdr) const;
};
