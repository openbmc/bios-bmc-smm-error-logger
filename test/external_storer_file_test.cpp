...
TEST_F(ExternalStorerFileWriterTest, CreateValidFolder)
{
    ...
    EXPECT_TRUE(
        std::filesystem::is_directory(baseDir / "valid_folder"));
}
...
TEST_F(ExternalStorerFileWriterTest, CreateFolderTraversal)
{
    ...
    EXPECT_FALSE(
        std::filesystem::is_directory(baseDir / "../invalid_folder"));
}
...
TEST_F(ExternalStorerFileWriterTest, CreateValidFile)
{
    ...
    EXPECT_TRUE(
        std::filesystem::exists(baseDir / "valid_file" / "index.json"));
}
...
TEST_F(ExternalStorerFileWriterTest, RemoveValidFile)
{
    ...
    EXPECT_FALSE(
        std::filesystem::exists(baseDir / "file_to_remove"));
}
